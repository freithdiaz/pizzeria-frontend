...
function calcularTotalModal() {
    ...
    console.log('DEBUG TOTAL:', {precioBase, precioAdicionales, cantidad, total}); if (totalEl) totalEl.textContent = '
...
function formatPrice(price) {
    ...
    if (typeof price === 'string') {
        // Si el string tiene punto como separador de miles (ej: "56.000"), quitarlo
        const cleanPrice = price.replace(/\./g, '').replace(',', '.');
        numPrice = parseFloat(cleanPrice.replace(/[^0-9.-]/g, ''));
    }
